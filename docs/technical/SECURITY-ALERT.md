...
**Value**: `***GATEWAY_API_KEY_REDACTED***`
...
# Revoke the key: ***GATEWAY_API_KEY_REDACTED***
...
### 🔴 ACTION REQUIRED
- **REVOKE API KEY**: `***GATEWAY_API_KEY_REDACTED***`
...
- [ ] **Revoke exposed API key** in Gateway dashboard
  ...
  - Find key: `***GATEWAY_API_KEY_REDACTED***`
...
- [ ] **Verify no secrets in git**
  ```bash
  git grep -i "***GATEWAY_API_KEY_REDACTED***" || echo "✅ Old key removed"
...
- [ ] **Remove from git history** (optional but recommended)
  ...
  bfg --replace-text <(echo '***GATEWAY_API_KEY_REDACTED***==>REDACTED') .git
