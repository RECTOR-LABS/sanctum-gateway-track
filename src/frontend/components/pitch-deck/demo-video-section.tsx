...
export function DemoVideoSection() {
  ...
  const videoUrl = 'https://www.youtube.com/embed/dQw4w9WgXcQ'; // Placeholder - UPDATE THIS
            ...
            <div className="aspect-video bg-gradient-to-br from-primary/20 via-primary/10 to-background">
              {!isPlaying ? (
                  ...
                  <div className="text-center space-y-8 p-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-muted-foreground text-xl max-w-2xl mx-auto">
                        See how Gateway Insights demonstrates real Gateway integration with production-ready analytics
                      </p>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                      <div className="px-6 py-3 rounded-full bg-primary/10 border-2 border-primary/30 backdrop-blur-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold">5:24 Duration</span>
                        </div>
                      </div>
                      <div className="px-6 py-3 rounded-full bg-primary/10 border-2 border-primary/30 backdrop-blur-sm">
                        <div className="flex items-center gap-2">
                ...
                <iframe
                  ...
                  title="Gateway Insights Demo - Hackathon Submission"
